function Block() {
    ...
    this.downHeight = baseObj.randomNum(0,150);//随机生成 0-150 之间的数 用于控制 down_div2 的高度
    this.gapHeight = baseObj.randomNum(150,160);//管道大中间的间隙，调剂大小 来控制难度
